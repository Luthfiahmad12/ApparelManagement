<x-app-layout title="Edit Products">
    <div>
        <h2 class="mb-2 text-3xl font-semibold">Edit Produk</h2>
        <div class="mb-8">
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                <div class="col-span-1 p-6 bg-white rounded-md shadow-md lg:col-span-2 dark:bg-neutral-800">
                    <div>
                        <x-input-label for="name" :value="__('Nama')" />
                        <x-text-input id="email" name="name" type="text" value="{{ $product->name }}"
                ...
                <div class="flex flex-col h-auto p-6 bg-white rounded-md shadow-md dark:bg-neutral-800">
                    <div class="flex-grow"> <!-- This will take up the available space -->
                        <div>
                            ...
                            <div class="flex justify-center">
                                <img src="{{ asset('storage/' . $product->image) }}"
                                    class="object-contain transition-transform duration-700 ease-out group-hover:scale-105"
                                    alt="Product Image" />
                            </div>
                        </div>
                    </div>
