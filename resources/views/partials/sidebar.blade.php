<nav id="page-sidebar"
    ...
    <div class="flex items-center justify-between flex-none w-full h-16 px-5 shadow-sm">
        ...
        <a href="javascript:void(0)"
            ...
            <svg class="inline-block w-6 h-6 transition hi-outline hi-video-camera text-rose-500 group-hover:scale-110"
                viewBox="0 0 128 128">
                <path fill="#f0513f"
        ...
        <div class="flex items-center">
            ...
            <button type="button"
                ...
                <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="inline-block w-5 h-5 hi-outline hi-moon">
                ...
                <svg x-cloak x-show="darkMode" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="inline-block w-5 h-5 hi-outline hi-sun">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <nav class="space-y-1">
                ...
                <div class="capitalize">
                    <x-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.*')">
                        ...
                        <span class="py-2 grow">katalog produk</span>
                    </x-nav-link>
                    <x-nav-link href="{{ route('materials.index') }}" :active="request()->routeIs('materials.*')">
                        ...
                        <span class="py-2 grow">Bahan</span>
                    </x-nav-link>
                </div>
